...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class DaggerHiltLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public DaggerHiltLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for androidx (androidx.hilt:hilt-compiler)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAndroidx() {
                return create("dagger.hilt.androidx");
        }
         ...
         */
        public DaggerHiltNavigationLibraryAccessors getNavigation() {
            return laccForDaggerHiltNavigationLibraryAccessors;
        }
    ...
    public static class DaggerHiltNavigationLibraryAccessors extends SubDependencyFactory {
        ...
        public DaggerHiltNavigationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             */
            public Provider<MinimalExternalModuleDependency> getCompose() {
                return create("dagger.hilt.navigation.compose");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: daggerHilt (2.49)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: daggerHiltAndroidx (1.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getDaggerHiltAndroidx() { return getVersion("daggerHiltAndroidx"); }

            /**
             * Returns the version associated to this alias: daggerHiltCompiler (2.49)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
