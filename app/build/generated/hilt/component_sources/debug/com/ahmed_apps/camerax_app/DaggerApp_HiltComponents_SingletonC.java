...
import com.ahmed_apps.camerax_app.presentation.CameraViewModel;
import com.ahmed_apps.camerax_app.presentation.CameraViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.ahmed_apps.camerax_app.presentation.CameraViewModel", ((Provider) cameraViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.ahmed_apps.camerax_app.presentation.CameraViewModel 
          return (T) new CameraViewModel(singletonCImpl.bindCameraRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.cameraRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 0);
      this.bindCameraRepositoryProvider = DoubleCheck.provider((Provider) cameraRepositoryImplProvider);
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.ahmed_apps.camerax_app.data.repository.CameraRepositoryImpl 
          return (T) new CameraRepositoryImpl(ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule));
